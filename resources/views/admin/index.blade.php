...
<head>
    ...
    <script type="text/javascript" src="../assets/admin/lib/PIE_IE678.js"></script>
    <![endif]-->
    ...
    <link href="../assets/admin/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin"/>
        ...
        <ul>
            <li class="dropDown dropDown_click"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">
                ...
                <ul class="dropDown-menu radius box-shadow">
                    <li><a href="javascript:;" onclick="article_add('添加资讯','article-add.html')"><i class="Hui-iconfont">
                                &#xe616;</i> 资讯</a></li>
                    <li><a href="javascript:;" onclick="picture_add('添加资讯','picture-add.html')"><i class="Hui-iconfont">
                                &#xe613;</i> 图片</a></li>
                    <li><a href="javascript:;" onclick="product_add('添加资讯','product-add.html')"><i class="Hui-iconfont">
                                &#xe620;</i> 产品</a></li>
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-product">
            ...
            <dd style="display: block;">
                <ul>
                    <li><a _href="/productlist" href="javascript:void(0)">产品管理</a></li>
                    <li><a _href="/orderlist" href="javascript:void(0)">订单管理</a></li>
                    <li><a _href="product-category.html" href="javascript:void(0)">分类管理</a></li>
                    <li><a _href="product-list.html" href="javascript:void(0)">留言管理</a></li>
                    <li><a _href="product-list.html" href="javascript:void(0)">幻灯片管理</a></li>
                </ul>
            </dd>
        </dl>
        <!-- <dl id="menu-comments">
